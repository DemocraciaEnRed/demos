...
exports.all = function all(fn) {
  ...
  Law
  .find({ deletedAt: null })
  .select('id lawId mediaTitle summary tag participants votes upvotes downvotes abstentions createdAt updatedAt closingAt publishedAt deletedAt status open closed links author authorUrl picture votable backgroundColor fontColor')
...
exports.comments = function comments(id, paging, fn) {
  ...
  var query = {
    $or: [
      { context: 'law', reference: id },
      { context: 'law', reference: mongoose.Types.ObjectId(id) }
    ]
  };
